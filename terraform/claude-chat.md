...
Review the code, identify issues or design flaws. Adjust or refactor be safe and maintainable for multiple environments. write a detailed plan.md document outlining how to implement this. include code snippets

---

bunch of reviews and requests to change plan and ask repeatedly with - I added a few notes to the document, address all the notes and update the document accordingly. don’t implement yet
